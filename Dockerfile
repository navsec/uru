...
RUN /bin/sh -c set -ex && apk -U upgrade && apk add libstdc++ cmake curl ca-certificates bash tar automake autoconf libtool libcurl curl-dev openssl-dev autoconf g++ make && \
